...
-- CreateEnum
CREATE TYPE "NotificationEvent" AS ENUM ('APPLICATION_STATUS_CHANGED', 'PROPOSAL_STATUS_CHANGED', 'PROGRESS_REPORT_SUBMITTED', 'PROGRESS_REPORT_SIGNED_OFF', 'THESIS_DOWNLOADED', 'REGISTRATION_EXPIRY_APPROACHING', 'VIVA_SCHEDULED', 'CORRECTIONS_REQUIRED', 'THESIS_ARCHIVED');
...
-- CreateEnum
CREATE TYPE "PanelEvaluationOutcome" AS ENUM ('PASS', 'FAIL');
...
CREATE TABLE "evaluation_forms" (
    ...
    "numericalScore" INTEGER NOT NULL,
...
-- CreateTable
CREATE TABLE "review_panel_student_assignments" (
    "id" TEXT NOT NULL,
    "reviewPanelId" TEXT NOT NULL,
    "studentId" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    CONSTRAINT "review_panel_student_assignments_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "supervisor_assignments_assignedBy_idx" ON "supervisor_assignments"("assignedBy");
...
-- CreateIndex
CREATE INDEX "panel_evaluations_progressReportId_supervisorId_idx" ON "panel_evaluations"("progressReportId", "supervisorId");

-- CreateIndex
CREATE UNIQUE INDEX "panel_evaluations_reviewPanelId_progressReportId_supervisor_key" ON "panel_evaluations"("reviewPanelId", "progressReportId", "supervisorId");

-- CreateIndex
CREATE UNIQUE INDEX "review_panel_student_assignments_studentId_key" ON "review_panel_student_assignments"("studentId");

-- CreateIndex
CREATE INDEX "review_panel_student_assignments_reviewPanelId_idx" ON "review_panel_student_assignments"("reviewPanelId");

-- CreateIndex
CREATE UNIQUE INDEX "review_panel_student_assignments_reviewPanelId_studentId_key" ON "review_panel_student_assignments"("reviewPanelId", "studentId");
...
-- CreateIndex
CREATE INDEX "thesis_examiner_assignments_assignedBy_idx" ON "thesis_examiner_assignments"("assignedBy");
...
-- AddForeignKey
ALTER TABLE "supervisor_assignments" ADD CONSTRAINT "supervisor_assignments_assignedBy_fkey" FOREIGN KEY ("assignedBy") REFERENCES "administrators"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "panel_evaluations" ADD CONSTRAINT "panel_evaluations_supervisorId_fkey" FOREIGN KEY ("supervisorId") REFERENCES "supervisors"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "review_panel_student_assignments" ADD CONSTRAINT "review_panel_student_assignments_reviewPanelId_fkey" FOREIGN KEY ("reviewPanelId") REFERENCES "review_panels"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "review_panel_student_assignments" ADD CONSTRAINT "review_panel_student_assignments_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "students"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "thesis_examiner_assignments" ADD CONSTRAINT "thesis_examiner_assignments_assignedBy_fkey" FOREIGN KEY ("assignedBy") REFERENCES "administrators"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
